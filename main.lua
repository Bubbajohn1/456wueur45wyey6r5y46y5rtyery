...
do
    ...
    function library:New(info)
        ...
        local accent = info.accent or info.Accent or info.color or info.Color or getgenv().theme.accent
        --
        getgenv().theme.accent = accent
        --
        ...
        local back_frame = utility:Create("Frame", {Vector2.new(1,1), inner_frame_inline2}, {
            ...
            Color = getgenv().theme.dark_contrast
        ...
        function window:Watermark(info)
            ...
            --
            local text_bounds = utility:GetTextBounds(watermark_name, getgenv().theme.textsize, getgenv().theme.font)
            --
        ...
        function window:KeybindsList(info)
            ...
            function window.keybindslist:Add(keybindname, keybindvalue)
                if keybindname and keybindvalue and not window.keybindslist.keybinds[keybindname] then
                    ...
                    --
                    local keybind_value = utility:Create("TextLabel", {Vector2.new(keybind_outline.Size.X - 4 - utility:GetTextBounds(keybindname, getgenv().theme.textsize, getgenv().theme.font).X,3), keybind_outline}, {
                        Text = "["..keybindvalue.."]",
                        Size = getgenv().theme.textsize,
                        Font = getgenv().theme.font,
                        Color = getgenv().theme.textcolor,
                        ...
                        Hidden = true,
                        ZIndex = 55,
                        Position = utility:Position(1, -4 - utility:GetTextBounds(keybindname, getgenv().theme.textsize, getgenv().theme.font).X, 0, 3, keybind_outline),
                        Visible = window.keybindslist.visible
                    })
                    --
        ...
        function window:Cursor(info)
            ...
            local cursor = utility:Create("Triangle", nil, {
                Color = getgenv().theme.cursoroutline,
                Thickness = 2.5,
                Filled = false,
                ZIndex = 65,
                Hidden = true
    ...
    function library:Page(info)
        ...
        --
        local textbounds = utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font)
        --
        ...
        function page:Show()
            if window.currentPage then
                ...
                window.currentPage.page_button_color.Color = getgenv().theme.dark_contrast
            ...
            page_button_color.Color = getgenv().theme.light_contrast
            page.open = true
            --
            for i,v in pairs(page.sections) do
                for z,x in pairs(v.visibleContent) do
    ...
    function pages:MultiSection(info)
        ...
        for i,v in pairs(msections) do
            ...
            --
            local textBounds = utility:GetTextBounds(v, getgenv().theme.textsize, getgenv().theme.font)
            --
            local msection_frame = utility:Create("Frame", {Vector2.new(multiSection.xAxis,0), multiSection_backFrame}, {
                ...
                Color = i == 1 and getgenv().theme.dark_contrast or getgenv().theme.light_contrast,
                Visible = page.open
            ...
            local msection_bottomline = utility:Create("Frame", {Vector2.new(0,msection_frame.Size.Y), msection_frame}, {
                ...
                Color = i == 1 and getgenv().theme.dark_contrast or getgenv().theme.outline,
                Visible = page.open
            ...
            library.began[#library.began + 1] = function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and page.open and  utility:MouseOverDrawing({msection_frame.Position.X,msection_frame.Position.Y,msection_frame.Position.X + msection_frame.Size.X,msection_frame.Position.Y + msection_frame.Size.Y}) and multiSection.currentSection ~= msection and not window:IsOverContent() then
                    multiSection.currentSection.msection_frame.Color = getgenv().theme.light_contrast
                    multiSection.currentSection.msection_bottomline.Color = getgenv().theme.outline
                    --
                    ...
                    msection_frame.Color = getgenv().theme.dark_contrast
                    msection_bottomline.Color = getgenv().theme.dark_contrast
                    --
                    for i,v in pairs(multiSection.currentSection.visibleContent) do
                        v.Visible = true
                    end
    ...
    function sections:Toggle(info)
        ...
        local toggle_frame = utility:Create("Frame", {Vector2.new(1,1), toggle_inline}, {
            ...
            Color = toggle.current == true and getgenv().theme.accent or getgenv().theme.light_contrast,
            Visible = page.open
        }, section.visibleContent)
        --
        ...
        --
        local toggle_title = utility:Create("TextLabel", {Vector2.new(23,toggle.axis + (15/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2)), section.section_frame}, {
            Text = name,
            Size = getgenv().theme.textsize,
            Font = getgenv().theme.font,
            Color = getgenv().theme.textcolor,
            OutlineColor = getgenv().theme.textborder,
            Position = utility:Position(0, 23, 0, toggle.axis + (15/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2), section.section_frame),
            Visible = page.open
        }, section.visibleContent)
        --
        ...
        function toggle:Set(bool)
            if bool or not bool then
                toggle.current = bool
                toggle_frame.Color = toggle.current == true and getgenv().theme.accent or getgenv().theme.light_contrast
                --
        ...
        function toggle:Keybind(info)
            ...
            function keybind:Reset()
                for i,v in pairs(keybind.modemenu.buttons) do
                    v.Color = v.Text == keybind.mode and getgenv().theme.accent or getgenv().theme.textcolor
                end
                --
            ...
            library.began[#library.began + 1] = function(Input)
                ...
                if keybind.selecting and window.isVisible then
                    ...
                    if done then
                        ...
                        keybind.active = keybind.mode == "Always" and true or false
                        keybind_frame.Color = getgenv().theme.light_contrast
                        --
                ...
                if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and keybind_outline.Visible then
                    if utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (40+4+2)), section.section_frame.Position.Y + keybind.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + keybind.axis + 17}) and not window:IsOverContent() and not keybind.selecting then
                        ...
                        keybind_frame.Color = getgenv().theme.dark_contrast
                    end
                    ...
                    if utility:MouseOverDrawing({section.section_frame.Position.X  + (section.section_frame.Size.X - (40+4+2)), section.section_frame.Position.Y + keybind.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + keybind.axis + 17}) and not window:IsOverContent() and not keybind.selecting then
                        ...
                        for i,v in pairs({"Always", "Toggle", "Hold"}) do
                            local button_title = utility:Create("TextLabel", {Vector2.new(modemenu_frame.Size.X/2,15 * (i-1)), modemenu_frame}, {
                                ...
                                Size = getgenv().theme.textsize,
                                Font = getgenv().theme.font,
                                Color = v == keybind.mode and getgenv().theme.accent or getgenv().theme.textcolor,
                                Center = true,
                                OutlineColor = getgenv().theme.textborder,
        ...
        function dropdown:Update()
            if dropdown.open and dropdown.holder.inline then
                for i,v in pairs(dropdown.holder.buttons) do
                    v[1].Color = v[1].Text == tostring(dropdown.current) and getgenv().theme.accent or getgenv().theme.textcolor
                    ...
                    if not dropdown.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            local dropdown_value = utility:Create("TextLabel", {Vector2.new(v == tostring(dropdown.current) and 8 or 6,2), dropdown_value_frame}, {
                                ...
                                Size = getgenv().theme.textsize,
                                Font = getgenv().theme.font,
                                Color = v == tostring(dropdown.current) and getgenv().theme.accent or getgenv().theme.textcolor,
                                OutlineColor = getgenv().theme.textborder,
        ...
        function multibox:Update()
            if multibox.open and multibox.holder.inline then
                for i,v in pairs(multibox.holder.buttons) do
                    v[1].Color = table.find(multibox.current, v[1].Text) and getgenv().theme.accent or getgenv().theme.textcolor
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            local multibox_value = utility:Create("TextLabel", {Vector2.new(table.find(multibox.current, v) and 8 or 6,2), multibox_value_frame}, {
                                ...
                                Size = getgenv().theme.textsize,
                                Font = getgenv().theme.font,
                                Color = table.find(multibox.current, v) and getgenv().theme.accent or getgenv().theme.textcolor,
                                OutlineColor = getgenv().theme.textborder,
    ...
    function sections:Keybind(info)
        ...
        --
        local keybind_title = utility:Create("TextLabel", {Vector2.new(4,keybind.axis + (17/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2)), section.section_frame}, {
            Text = name,
            Size = getgenv().theme.textsize,
            Font = getgenv().theme.font,
            Color = getgenv().theme.textcolor,
            OutlineColor = getgenv().theme.textborder,
            Position = utility:Position(0, 4, 0, keybind.axis + (17/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2), section.section_frame),
            Visible = page.open
        }, section.visibleContent)
        --
        local keybind__gradient = utility:Create("Image", {Vector2.new(0,0), keybind_frame}, {
    ...
    function sections:Colorpicker(info)
        ...
        --
        local colorpicker_title = utility:Create("TextLabel", {Vector2.new(4,colorpicker.axis + (15/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2)), section.section_frame}, {
            Text = name,
            Size = getgenv().theme.textsize,
            Font = getgenv().theme.font,
            Color = getgenv().theme.textcolor,
            OutlineColor = getgenv().theme.textborder,
            Position = utility:Position(0, 4, 0, colorpicker.axis + (15/2) - (utility:GetTextBounds(name, getgenv().theme.textsize, getgenv().theme.font).Y/2), section.section_frame),
            Visible = page.open
        }, section.visibleContent)
        --
        if transp then
    ...
    function sections:ConfigBox(info)
        ...
        for i=1, 8 do
            local config_title = utility:Create("TextLabel", {Vector2.new(configLoader_frame.Size.X/2,2 + (18 * (i-1))), configLoader_frame}, {
                ...
                Size = getgenv().theme.textsize,
                Font = getgenv().theme.font,
                Color = i == 1 and getgenv().theme.accent or getgenv().theme.textcolor,
                OutlineColor = getgenv().theme.textborder,
                Center = true,
        ...
        function configLoader:Refresh()
            for i,v in pairs(configLoader.buttons) do
                v.Color = i == configLoader.current and getgenv().theme.accent or getgenv().theme.textcolor
            end
        end
        --
